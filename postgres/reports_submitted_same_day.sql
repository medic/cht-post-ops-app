SELECT
y.study_no,
y."0/1 Report Submit Date",
d."0/1 Response"
FROM

(SELECT 
study_no,
"0/1 Report Submit Date",
...
GROUP BY study_no, "0/1 Report Submit Date"
having count("0/1 Report Submit Date") > 1
) y
JOIN
(
...
ON y.study_no = d.study_no and y."0/1 Report Submit Date" = d."0/1 Report Submit Date" 