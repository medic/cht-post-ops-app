DROP VIEW formview_day2_sms;
CREATE OR REPLACE VIEW formview_day2_sms AS 
    SELECT
        doc ->> '_id'                                AS uuid,
    ...
    FROM couchdb form
    WHERE
        form.doc ->> 'form'::text = 'day7_sms'::text
        AND doc #>> '{contact, parent, _id}' = '00c7c0bd-f01f-44b2-9fbe-48c4e12c6fc7';  -- Boom Clinic
ALTER VIEW formview_day2_sms OWNER TO full_access;
