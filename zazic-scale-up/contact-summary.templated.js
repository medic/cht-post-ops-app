...
const fields = [
    ...
    { appliesToType: 'person', appliesIf: !isNurse, label: 'person.field.phone', value: thisContact.phone, width: 4, filter: 'phone' },
    { appliesToType: 'person', appliesIf: !isNurse, label: 'person.field.alternate_phone', value: thisContact.phone, width: 4, filter: 'phone' },
    { appliesToType: 'person', appliesIf: !isNurse, label: 'contact.age', value: thisContact.date_of_birth, width: 4, filter: 'age' },
    { appliesToType: 'person', appliesIf: !isNurse, label: 'contact.days_since_enrollment', value: daysSinceEnrollment, width: 6 },
    { appliesToType: 'person', appliesIf: !isNurse, label: 'contact.enrollment_date', value: contact.reported_date, width: 6, filter: 'date' },
